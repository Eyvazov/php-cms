    ...
    <section class="error">
        ...
        <div class="error__content">
            <div class="error__message message">
                <h1 class="message__title">SƏHİFƏ MÖVCUD DEYİL!</h1>
                <p class="message__text">Axtardığınız Səhifə Mövcud Deyil</p>
            </div>
            <div class="error__nav e-nav">
                <a href="<?= site_url()?>" target="_blanck" class="e-nav__link"></a>
            </div>
        </div>
        <!-- END Content -->
